(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#light').on('click', function () {
            ...
            $("#logo").attr("src", "assets/images/logo-dark-n.html");
            $("img[src='assets/images/user/vs.png']").attr("src", "assets/images/user/ac-vs.html");
            $("img[src='assets/images/profile/referral.png']").attr("src", "assets/images/profile/ac-ref.html");
            $("img[src='assets/images/profile/last_month.png']").attr("src", "assets/images/profile/ac-last.html");
        });
